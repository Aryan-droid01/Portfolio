    ...
    <section id="contact" ref={sectionRef} className="contact-section">
      ...
      <div className="contact-container">
        ...
        <div className="contact-footer-description">
          <p className="contact-footer-message">
            That's the portfolio. If you've got an idea, a problem, or just want to talk design, my inbox is always open.
          </p>
          <p className="contact-footer-copyright">
            © 2026 Aryan Verma. All rights reserved.
          </p>
        </div>
      </div>
    </section>
