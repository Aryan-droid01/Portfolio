...
const FuzzyText = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      if (fontFamily === 'inherit' || fontFamily.includes('var(')) {
        const temp = document.createElement('span');
        temp.style.fontFamily = fontFamily === 'inherit' ? window.getComputedStyle(canvas).fontFamily : fontFamily;
        document.body.appendChild(temp);
        computedFontFamily = window.getComputedStyle(temp).fontFamily || 'sans-serif';
