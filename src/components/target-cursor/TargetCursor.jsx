...
// will-change of those, or contain). Since we render this directly inside a React
// portal under document.body, containingBlockOffset will always be 0, ensuring
// perfect screen space mapping.
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      corners.forEach((corner, i) => {
        ...
        // Perform smooth lerp inside the animation frame loop
        const finalX = currentX + (targetX - currentX) * 0.25 * strength;
        const finalY = currentY + (targetY - currentY) * 0.25 * strength;
    ...
    const updateTargetCoords = (target) => {
      if (!target) return;
